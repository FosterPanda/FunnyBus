		...
		<div class="container-fluid">
			...
			<div class="col-md-offset-5 col-xs-offset-5" class="collapse navbar-collapse" id="myNavbar">
				<ul class="nav navbar-nav">
					<li class="active"><a href="/booking/ua">Україна</a></li>
					<li><a href="/booking/ch">Чехія</a></li>
					<li><a href="/booking/pl">Польща</a></li>
				</ul>
			</div>
		</div>
	</nav>
	...
	<div class="col-md-offset-2 col-md-7 col-xs-12">
		<div class="row">
			<div class="col-md-12 col-xs-12">
				<form:form class="form-horizontal" action="/booking/ua" method="POST" modelAttribute="bookingUa">
