...
<%@ taglib uri="http://www.springframework.org/tags/form" prefix="form"%>
  ...
  <content>
        ...
        <div class="container">
            <h3>Добро дня, шановні пасажири! Вітаємо вас на нашому сайті!</h3>
            <p>Funny Bus (Веселий Автобус) - це рейсовий автобус, який здійснює пасажирські перевезення по маршруту: Городенка - Івано-Франківськ - Прага.</p>
            <p>На нашому сайті ви можете забронювати квиток, а оплату здійснювати вже безпосередньо під час поїздки. Для цього вам потрібно забронювати квиток і ми вам передзвонимо.</p>
            <p>Ми завжди стараємося покращувати сервіс, щоб зробити вашу поїздку максимально комфортною і щоб у вас залишилися тільки приємні та позитивні враження. Саме тому ми створюємо для вас сервіс європейського класу. У наших автобусах під час усієї поїздки вас супроводжуватиме стюардеса, яка у всьому вам допомагатиме. У нас завжди є безкоштовні напої, а також ми часто готуємо для наших пасажирів різноманітні приємні сюрпризи і акції. Детальніше з усіма зручностями ви можете ознайомитися у розділі міжнародних перевезень.</p>
