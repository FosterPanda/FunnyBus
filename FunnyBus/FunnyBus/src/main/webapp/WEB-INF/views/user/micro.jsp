		...
		<div class="container-fluid">
			...
			<div class="col-md-offset-5 col-xs-offset-5" class="collapse navbar-collapse" id="myNavbar">
				<ul class="nav navbar-nav">
					<li><a href="/booking/bus">Автобусні рейси</a></li>
					<li class="active"><a href="/booking/micro">Рейси мікроавтосів</a></li>
				</ul>
			</div>
		</div>
	</nav>
...
<div class="row">
	<div class="col-md-offset-2 col-md-7 col-xs-12">
		<div class="row">
			<div class="col-md-12 text-center"><h4>Україна-Словаччина-Чехія</h4></div>
				<form:form class="form-horizontal" action="/booking/micro" method="POST" modelAttribute="bookingMicro">
