		...
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse" id="myNavbar">
				<ul class="nav navbar-nav">
					...
					<li class="active"><a href="/admin/ua">Україна</a></li>
		...
		<div class="row">
			...
			<c:forEach items="${page.content}" var="booking">
				<div class="row">
					...
					<div class="col-md-5 col-xs-5">${booking.trip.way} ${booking.trip.data} місць:${booking.place}</div>
  					<div class="col-md-2 col-xs-2"><a class="btn btn-danger" href="/admin/pl/delete/${booking.id}">delete</a></div>
				</div>
			</c:forEach>
	</div>
</div>
