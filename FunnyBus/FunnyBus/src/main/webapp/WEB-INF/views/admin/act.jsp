	...
	<nav class="navbar navbar-default">
		<div class="container-fluid">
			...
			<div class="container">
				...
				<ul class="nav navbar-nav adminsHeader">
					<li><a href="/admin/new">Новини</a></li>
					<li><a href="/admin/aid">Допомога біцям АТО</a></li>
					<li class="active"><a href="/admin/act">Акції</a></li>
...
<div class="row">
	<div class="col-md-12 col-xs-12">
		<div class="row">
			<div class="col-md-12 col-xs-12">
				<form:form class="form-horizontal" action="/admin/act" method="POST" modelAttribute="act" enctype="multipart/form-data">
		...
		<div class="row">
			...
			<c:forEach items="${page.content}" var="act">
				<div class="row">
					<div class="col-md-2 col-xs-2 col-md-offset-1 col-xs-offset-1"><img src="/images/act/${act.id}.jpg?version=${act.version}" width="100%"></div>
					<div class="col-md-1 col-xs-1">${act.data}</div>
					<div class="col-md-2 col-xs-2">${act.title}</div>
					<div class="col-md-4 col-xs-4">${act.info}</div>
					<div class="col-md-1 col-xs-1"><a class="btn btn-warning" href="/admin/act/update/${act.id}">оновити</a></div>
  					<div class="col-md-1 col-xs-1"><a class="btn btn-danger" href="/admin/act/delete/${act.id}">видалити</a></div>
				</div>
