...
@Controller
@RequestMapping("/booking/ch")
@SessionAttributes("bookingCh")
public class BookingChController {
	...
	public String show(Model model){
		model.addAttribute("trips", tripService.findOnWay("Чехія"));
		return "user-ch";
	}
	@PostMapping
	public String save(@ModelAttribute("bookingCh")@Valid BookingForm bookingForm,BindingResult br, Model model, SessionStatus status){
