...
@Controller
@RequestMapping("/booking/pl")
@SessionAttributes("bookingPl")
public class BookingPlController {
	...
	public String show(Model model){
		model.addAttribute("trips", tripService.findOnWay("Польща"));
		return "user-pl";
	}
	@PostMapping
	public String save(@ModelAttribute("bookingPl")@Valid BookingForm bookingForm,BindingResult br, Model model, SessionStatus status){
