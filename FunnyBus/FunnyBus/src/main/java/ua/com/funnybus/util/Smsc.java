/*
 * SMSC.UA API (smsc.ua) версия 1.2 (19.02.2017) smsc's sms sender package
 */
package ua.com.funnybus.util;
...
public class Smsc {
	...
	String SMSC_LOGIN    = "SaurOff";     // логин клиента
	String SMSC_PASSWORD = "70f9716c87798dcb5434d1d6fcaeca31";  // пароль или MD5-хеш пароля в нижнем регистре
...
//	}
	...
	private String[] _smsc_send_cmd(String cmd, String arg){
		...
		try {
			String _url = (SMSC_HTTPS ? "https" : "http") + "://smsc.ua/sys/" + cmd +".php?login=" + URLEncoder.encode(SMSC_LOGIN, SMSC_CHARSET)
